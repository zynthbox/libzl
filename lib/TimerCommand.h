...
struct TimerCommand {
    ...
    enum Operation {
        ...
        StartPartOperation = 2, ///@< Start playing the given part. Pass track index as parameter 1 and part index as parameter2
        StopPartOperation = 4, ///@< Stop playing the given part. Pass track index as parameter 1 and part index as parameter2
    };
